...
<div class="layui-container">
    ...
    <form id="loginForm" class="layui-form" method="post" action="" style="float:right;">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" lay-submit="" data-type="btnLogin" lay-filter="btnLogin">登录</button>
