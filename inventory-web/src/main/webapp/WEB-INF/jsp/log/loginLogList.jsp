...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body" style="margin: 1%">
        ...
        <shiro:hasPermission name="loginLog:clear">
            <div class="layui-btn layui-btn-danger" data-type="btnClear" id="btnClear">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/business/log/loginLogList.js"></script>
